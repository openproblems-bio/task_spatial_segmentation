// cell_type_annotation_tacco build_segger
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/data_processors/cell_type_annotation_tacco/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'input_processed_prediction': $( if [ ! -z ${VIASH_PAR_INPUT_PROCESSED_PREDICTION+x} ]; then echo "r'${VIASH_PAR_INPUT_PROCESSED_PREDICTION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_segmentation/data_processors/cell_type_annotation_tacco",
    "tag" : "build_segger"
  },
  "label" : [
    "midtime",
