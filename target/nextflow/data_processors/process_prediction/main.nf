// process_prediction build_segger
// 
...
meta = [
  ...
  "info" : {
    ...
    "type_info" : {
      ...
      "description" : "A component for a prediction dataset into a processed prediction dataset that can be evaluated by the metrics.\n"
    }
  },
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/data_processors/process_prediction/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'input_spatial_unlabelled': $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_UNLABELLED+x} ]; then echo "r'${VIASH_PAR_INPUT_SPATIAL_UNLABELLED//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_segmentation/data_processors/process_prediction",
    "tag" : "build_segger"
  },
  "label" : [
    "midmem",
