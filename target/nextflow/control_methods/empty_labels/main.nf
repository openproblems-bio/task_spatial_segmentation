...
meta = [
  ...
  "label" : "Empty Labels",
  "summary" : "A negative control that predicts no cells (all background).",
  "description" : "A negative control where no cells are detected — the segmentation label image\nis filled with zeros (background). This represents a lower bound of performance\nfor any segmentation method and is useful for verifying that metrics can\ndistinguish between no prediction and a perfect prediction.\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/control_methods/empty_labels/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/control_methods/empty_labels",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_segmentation/control_methods/empty_labels",
    "tag" : "build_segger"
  },
  "label" : [
    "midtime",
