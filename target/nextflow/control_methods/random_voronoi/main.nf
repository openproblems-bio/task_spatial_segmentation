...
meta = [
  ...
  "label" : "Random Voronoi",
  "summary" : "A negative control that assigns pixels to randomly placed seed points via Voronoi tessellation.",
  "description" : "A negative control that places N seed points uniformly at random across the\nimage (where N equals the number of cells in the ground truth) and assigns\neach pixel to the nearest seed. This produces spatially coherent, non-overlapping\ncells with realistic count but no biological basis, resulting in poor metric scores.\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/control_methods/random_voronoi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_segmentation/control_methods/random_voronoi",
    "tag" : "build_segger"
  },
  "label" : [
    "midtime",
