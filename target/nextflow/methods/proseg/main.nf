...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/methods/proseg/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'voxel_layers': $( if [ ! -z ${VIASH_PAR_VOXEL_LAYERS+x} ]; then echo "int(r'${VIASH_PAR_VOXEL_LAYERS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_segmentation/methods/proseg",
    "tag" : "build_segger"
  },
  "label" : [
    "hightime",
