...
meta = [
  ...
  "engines" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          ...
          "user" : false,
          "script" : [
            "from cellpose.models import CellposeModel; model = CellposeModel()"
          ],
          "upgrade" : true
        }
      ]
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/methods/cellpose/config.vsh.yaml",
    "runner" : "nextflow",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_segmentation/methods/cellpose",
    "tag" : "build_segger"
  },
  "label" : [
    "midtime",
