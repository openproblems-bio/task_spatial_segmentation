...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/workflows/process_datasets/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
