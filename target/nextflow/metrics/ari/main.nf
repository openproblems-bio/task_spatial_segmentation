...
meta = [
    ...
    "metrics" : [
      {
        ...
        "summary" : "ARI between ground truth and predicted transcript-to-cell assignments.",
        "description" : "For each transcript, its cell ID is looked up in both the ground truth\nlabel image (cell_labels) and the predicted segmentation label image.\nThe Adjusted Rand Index (ARI) is then computed between the two resulting\nassignment vectors. ARI = 1 is perfect agreement; values near 0 are random.\nBackground transcripts (cell_id = 0 in both) are excluded.\n",
        "references" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_segmentation/task_spatial_segmentation/src/metrics/ari/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/ari",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_segmentation/metrics/ari",
    "tag" : "build_segger"
  },
  "label" : [
    "midtime",
